...
| `HUL-C` Jev scope gate | **in progress** | **PR #48** `feat/hul-cd-scope-driver` @ `4ccec8f`; merge when CI audit BAR MET |
| `HUL-D` until-limits driver | **in progress** | **PR #48** `4ccec8f`; cost-limit terminal fail-closed |
