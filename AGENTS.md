...
| Next code | **HUL-B** (`Harness-hul-b`), **HUL-C/D** (`Harness-hul-cd`), **P4 ops** (`Harness-p4`) |
| Also planned | HUL-B/C/D product; P4 checklist + dogfood evidence; paid hourglass battery; PR #39 completion-score disposition |
